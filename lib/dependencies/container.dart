...
/// This file belongs to page_indicator package.
/// It was copied manually and used here because
/// of this https://github.com/flutter/flutter/issues/52014 issue
/// and this https://github.com/dart-lang/pub/issues/2806 issue
///
...
class PageContainerState extends State<PageIndicatorContainer> {
  ...
  Widget build(BuildContext context) {
    if (widget.child is! CustomPageView) {
      return widget.child;
    }
  ...
  CustomPageView get pageView => widget.child;
